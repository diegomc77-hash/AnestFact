...
**id:** cyc-tiroides-paratiroides-v1 · especialidad: Cirugía de Cabeza y Cuello · **OK Huerta v2** (6 variantes, texto fijo)

Índice: [README.md](README.md)

Reescritura Huerta: 6 variantes top-level; texto fijo de protocolos; slots solo en variables.
**Sistrunk** fuera de este id (otra rama). **Istmectomía** aislada: pendiente sin texto real.
...
# Fuera de este id: Sistrunk (otra rama). Istmectomía aislada: pendiente sin texto.
...
slots:
  ...
  # ========== V1 / V2 — hallazgos compartidos total ==========
  - id: caracteristica_glandula_v1
    type: single
    required: false
    required_if_variante: ["Tiroidectomía total con neuromonitoreo"]
  ...
  - id: caracteristica_glandula_v2
    type: single
    required: false
    required_if_variante: ["Tiroidectomía total sin neuromonitoreo"]
    label: Característica de la glándula
    options:
      - Multinodular
      - Nodular
  ...
  - id: caracteristicas_nodulo
    type: free
    required: false
    required_if_variante: [Hemitiroidectomía]
  ...
  - id: nodulo_resecado_con_estructuras
    type: free
    required: false
    required_if_nodulo_adherencias: ["Con adherencias a estructuras adyacentes"]
    label: Estructuras resecadas en bloque con el nódulo
    empty_text: ""

  # ========== Bloque Adherencias — adenopatía ==========
  - id: adenopatia_adherencias
    type: single
    required: false
    required_if_hallazgo_exploracion: [Adenopatías]
  ...
  - id: adenopatia_resecado_con_estructuras
    type: free
    required: false
    required_if_adenopatia_adherencias: ["Con adherencias a estructuras adyacentes"]
    label: Estructuras resecadas en bloque con la adenopatía
    empty_text: ""

  # ========== Bloque Nervio Recurrente — total (bilateral) ==========
  ...
  # ========== Bloque Nervio Recurrente — hemi (lado operado) ==========
  - id: usa_nim
    type: single
    required: false
    required_if_variante: [Hemitiroidectomía]
  ...
  # ========== Bloque Paratiroides — 4 glándulas (total / TOETVA) ==========
  # ids: sd=sup der, id=inf der, si=sup izq, ii=inf izq
  ...
  - id: paratiroides_sitio_reimplante_sd
    type: free
    required: false
    required_if_paratiroides_estado_sd: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_sd
    type: free
    required: false
    required_if_paratiroides_estado_sd: ["No identificada"]
  ...
  - id: paratiroides_sitio_reimplante_id
    type: free
    required: false
    required_if_paratiroides_estado_id: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_id
    type: free
    required: false
    required_if_paratiroides_estado_id: ["No identificada"]
  ...
  - id: paratiroides_sitio_reimplante_si
    type: free
    required: false
    required_if_paratiroides_estado_si: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_si
    type: free
    required: false
    required_if_paratiroides_estado_si: ["No identificada"]
  ...
  - id: paratiroides_sitio_reimplante_ii
    type: free
    required: false
    required_if_paratiroides_estado_ii: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_ii
    type: free
    required: false
    required_if_paratiroides_estado_ii: ["No identificada"]
    label: Motivo no identificación (paratiroides II)
    empty_text: ""

  # ========== Bloque Paratiroides — hemi (2 del lado operado) ==========
  ...
  - id: paratiroides_sitio_reimplante_hemi_sup
    type: free
    required: false
    required_if_paratiroides_estado_hemi_sup: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_hemi_sup
    type: free
    required: false
    required_if_paratiroides_estado_hemi_sup: ["No identificada"]
  ...
  - id: paratiroides_sitio_reimplante_hemi_inf
    type: free
    required: false
    required_if_paratiroides_estado_hemi_inf: ["Identificada y reimplantada"]
  ...
  - id: paratiroides_motivo_hemi_inf
    type: free
    required: false
    required_if_paratiroides_estado_hemi_inf: ["No identificada"]
    label: Motivo no identificación (paratiroides inferior hemi)
    empty_text: ""

  # ========== Bloque Cierre (V1–V5; opciones de drenaje por variante) ==========
  ...
  - id: tecnica_sutura
    ...
    options: [Surget, Puntos separados]
  ...
  - id: tipo_drenaje_para
    type: single
    required: false
    required_if_variante: [Paratiroidectomía]
    label: Tipo de drenaje
    options:
      - Tubular aspirativo
      - Laminar
  ...
  - id: paratiroidectomia_lado
    type: single
    required: false
    required_if_paratiroidectomia_alcance: [Unilateral]
    label: Lado
    options: [Derecho, Izquierdo]
  ...
  - id: paratiroides_remanente_cual
    type: free
    required: false
    required_if_paratiroidectomia_extension: ["Subtotal (3 glándulas + mitad de la 4ª)"]
  ...
  - id: nervio_recurrente_estado_para
    type: single
    required: false
    required_if_incluir_evaluacion_nlr_para: [Sí]
  ...
  # ========== V5 — TOETVA (literales Huerta → slots en [ ]) ==========
  ...
  - id: motivo_conversion
    type: free
    required: false
    required_if_conversion_toetva: ["Convertida a cervicotomía abierta"]
  ...
  # ========== V6 — Ablación unificada RF / Microondas ==========
  - id: tecnica_ablacion
    type: single
    required: false
    required_if_variante: ["Ablación percutánea"]
    label: Técnica de ablación
    options: [Radiofrecuencia, Microondas]
  ...
  - id: manejo_quiste
    type: single
    required: false
    required_if_componente_quistico: ["Con componente quístico"]
  ...
  - id: volumen_etanol_ml
    type: free
    required: false
    required_if_manejo_quiste: ["Aspiración + alcoholización"]
  ...
  - id: volumen_aspirado_ml
    type: free
    required: false
    required_if_manejo_quiste: ["Aspiración + termoablación"]
  ...
  - id: hidrodiseccion_compartimento
    type: free
    required: false
    required_if_hidrodiseccion_realizada: [Sí]
  ...
  - id: complicacion_hemorragia_detalle
    type: free
    required: false
    required_if_complicacion_hemorragia: [Hemorragia]
    label: Manejo de la hemorragia
    empty_text: ""

plantilla_texto: |
  {{#if_eq variante "Tiroidectomía total con neuromonitoreo"}}
