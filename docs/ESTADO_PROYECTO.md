...
- 2026-08-27 — Lote 2 SISalud select (PWA **12.40**): `#f-san` = desarrollado ∩ permitidos; 3 hospitales append **solo** a Huerta. Esperando Pages (flujo real). Admin ve los 5 desarrollado.
...
- Instituciones: catálogo **010** + **011** + **012** + **013** + **014** (013 = extras Huerta; 014 = Guardar plan no los pisa). Habilitar resto = `sanatorios_permitidos` + `desarrollado`, no re-sembrar. String legado `Clínica Allende` sigue en el array de Huerta; no sale en el select.
