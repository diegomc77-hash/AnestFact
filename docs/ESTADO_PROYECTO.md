...
- **Infra:** ver `docs/AVISO_INFRA_GRANTS_MIGRACION.md`. **Ticket 8:** cola EVWEB con mismas clases `.afg-q-*` / color-por-estado que GECLISA (PWA **13.02**). **Ticket 6** en main (13.01). **Ticket 5** POSPUESTO.
