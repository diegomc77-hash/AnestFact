...
- 2026-08-26 — Etapa A visual: paleta de 5 familias + lockup (login, header, QR). Estados: Borrador gris / Listo azul. Sanatorios: Mayo cielo, Aeronáutico violeta (ya no naranja). Bump PWA **12.28**. Etapa B/C (dock) no tocada.
...
- Etapa B/C visual: dock 7 secciones + ocultar dock en foja. Esperar validación de A en producción.
