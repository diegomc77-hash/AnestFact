...
- **Infra:** ver `docs/AVISO_INFRA_GRANTS_MIGRACION.md`. **Ticket 9a/9b:** validate bloquea prácticas sin `codigoEvweb`; lista muestra "Sin código EVWEB" + "Sin: docs" (PWA **13.03**). **Ticket 8** cerrado. **Ticket 5** POSPUESTO.
