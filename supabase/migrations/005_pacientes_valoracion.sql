...
-- ---------------------------------------------------------------------------
-- 6b) Data API grants (obligatorio post-2026-10-30; ver docs/AVISO_INFRA_GRANTS_MIGRACION.md)
--     RLS sigue limitando filas; sin estos GRANT la API responde permission denied.
-- ---------------------------------------------------------------------------
