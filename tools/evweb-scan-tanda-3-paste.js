/**
 * AnesFact — EVWEB scan Tanda 3/3
 * Obras: 263=PREVENCION (FONDO DE RESERVA | 437=APOS SANATORIO MAYO PRIVADO  | 420=PROVINCIA ART DESDE 01.05.22 | 70=PRODUCTORES DE FRUTAS ARGENT
...
(async function () {
  'use strict';
  var TANDA = 3;
  var OBRAS = [{"id":"263","nombre":"PREVENCION (FONDO DE RESERVA)"},{"id":"437","nombre":"APOS SANATORIO MAYO PRIVADO SOCIEDAD ANONIMA"},{"id":"420","nombre":"PROVINCIA ART DESDE 01.05.22"},{"id":"70","nombre":"PRODUCTORES DE FRUTAS ARGENTINAS COOP.DE SEG.LDTA"}];
  ...
  var fname = 'evweb_practicas_tanda' + TANDA + '_263-437-420-70_' + Date.now() + '.csv';
