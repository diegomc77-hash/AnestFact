/**
 * AnesFact — EVWEB scan Tanda 2/3
 * Obras: 76=COOPERATIVA DE VIVIENDA CONS | 227=BERKLEY | 37=OSPECOR (OBRA SOCIAL DE PETR | 5=LA HOLANDO ART
...
(async function () {
  'use strict';
  var TANDA = 2;
  var OBRAS = [{"id":"76","nombre":"COOPERATIVA DE VIVIENDA CONSUMO Y CREDITO HORIZONTE LIMITADA"},{"id":"227","nombre":"BERKLEY"},{"id":"37","nombre":"OSPECOR (OBRA SOCIAL DE PETROLEROS DE CORDOBA)"},{"id":"5","nombre":"LA HOLANDO ART"}];
  ...
  var fname = 'evweb_practicas_tanda' + TANDA + '_76-227-37-5_' + Date.now() + '.csv';
