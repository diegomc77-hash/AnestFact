...
var TITLES={home:afHomeTitle(),preop:'Preoperatorio',sanatorios:'Instituciones',evweb:'evweb',legales:'Legales',herramientas:'Herramientas',nueva:'Nueva intervención',facturacion:'Facturación evweb',escanear:'Escanear',config:'Configuración',foja:'Foja anestésica',fojaQx:'Foja quirúrgica',nom:'Prácticas ADAARC',resumen:'Resumen evweb',geclisa:'GECLISA',ayuda:'Mesa de ayuda',admin:'Panel admin'};
